...
"#;
        ...
        assert!(suppressions.is_suppressed(RuleId::Pgm001, 5));
        assert!(suppressions.is_suppressed(RuleId::Pgm501, 5));
        assert!(!suppressions.is_suppressed(RuleId::Pgm002, 5));
    }
...
"#;
        ...
        let suppressions = parse_suppressions(source);
        assert!(suppressions.is_suppressed(RuleId::Pgm001, 5));
        assert!(!suppressions.is_suppressed(RuleId::Pgm001, 2));
    }
...
"#;
        ...
        let suppressions = parse_suppressions(source);
        assert!(suppressions.is_suppressed(RuleId::Pgm001, 3));
...
<databaseChangeLog>
    ...
    <changeSet id="1" author="dev">
        ...
        assert!(
            suppressions.is_suppressed(RuleId::Pgm001, 4),
            "PGM001 should be suppressed on line 4"
        );
        assert!(
            !suppressions.is_suppressed(RuleId::Pgm002, 4),
...
<databaseChangeLog>
    ...
    <changeSet id="1" author="dev">
        ...
        let suppressions = parse_suppressions(source);
        assert!(suppressions.is_suppressed(RuleId::Pgm001, 4));
        assert!(suppressions.is_suppressed(RuleId::Pgm501, 4));
        assert!(!suppressions.is_suppressed(RuleId::Pgm002, 4));
    }
...
<databaseChangeLog>
    <changeSet id="1" author="dev">
        ...
        assert!(suppressions.is_suppressed(RuleId::Pgm001, 5));
        assert!(suppressions.is_suppressed(RuleId::Pgm501, 5));
        assert!(suppressions.is_suppressed(RuleId::Pgm001, 99));
        assert!(!suppressions.is_suppressed(RuleId::Pgm002, 5));
    }
    ...
    fn test_xml_comment_whitespace_variants() {
        ...
        assert!(
            s1.is_suppressed(RuleId::Pgm001, 2),
        ...
        assert!(
            s2.is_suppressed(RuleId::Pgm001, 2),
        ...
        assert!(
            s3.is_suppressed(RuleId::Pgm001, 2),
        ...
        assert!(
            s4.is_suppressed(RuleId::Pgm001, 2),
...
<changeSet id="1" author="dev">"#;
        ...
        assert!(
            !suppressions.is_suppressed(RuleId::Pgm001, 2),
    ...
    fn test_rule_ids_returns_line_level_rules() {
        ...
        assert!(ids.contains(&RuleId::Pgm002), "should contain PGM002");
    }
    ...
    fn test_rule_ids_combines_file_and_line_level() {
        ...
        assert!(
            ids.contains(&RuleId::Pgm001),
            "should contain file-level PGM001"
        );
        assert!(
            ids.contains(&RuleId::Pgm002),
    ...
    fn test_skip_arithmetic_equivalent_mutant_coverage() {
        ...
        assert!(s1.is_suppressed(RuleId::Pgm001, 2));
        assert!(!s1.is_suppressed(RuleId::Pgm001, 1));
        ...
        assert!(s2.is_suppressed(RuleId::Pgm001, 4));
        assert!(!s2.is_suppressed(RuleId::Pgm001, 3));
    }
}
