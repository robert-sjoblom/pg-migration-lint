...
/// Volatile functions from pg_catalog (sorted for binary search).
const VOLATILE: &[&str] = &[
    "amvalidate",
    "array_sample",
    "array_shuffle",
...
/// Stable functions from pg_catalog (sorted for binary search).
const STABLE: &[&str] = &[
    "aclexplode",
    "aclitemin",
    "aclitemout",
...
/// Immutable functions from pg_catalog (sorted for binary search).
const IMMUTABLE: &[&str] = &[
    "abbrev",
    "abs",
    "aclcontains",
